...
export function UpsetIcon(props: ComponentPropsWithRef<"svg">) {
  return (
    <svg
      fill="none"
      height="14"
      id="Smiley-Crying-1--Streamline-Core"
      viewBox="0 0 14 14"
      width="14"
      xmlns="http://www.w3.org/2000/svg"
      {...props}
    >
      <title>Smiley Crying 1 Streamline Icon: https://streamlinehq.com</title>
